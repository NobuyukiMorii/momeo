...
- `docs/research/continuous_listening/recording_segmentation_whisper.md` — 本書の方向Aを具体化した実装手段の調査（録音・VAD・Whisper パッケージ／日本語モデル選定）
- `docs/research/continuous_listening/continuous_listening_limitation.md` — 今回の `speech_to_text` アプローチの限界
