...
- サイズの心配は無用。**公式の上限は1パック1.5GB**なので、NeMo（625MB）は**1つの fast-follow パックに余裕で収まる**。
...
### 2-1. サイズ上限：625MB は1パックに余裕で収まる

**Google Play の公式サイズ上限**は次のとおり：
...
→ **NeMo（625MB）は1つの fast-follow パックに余裕で収まる**。
（なお公式は「install-time はパック容量の**2倍**のディスクが要る」とも明記。これは install-time の「約1.25GB（同梱＋コピー）」を裏づける。）
...
- サイズは懸念にならない（公式上限 1.5GB に 625MB は余裕で収まる）ので、fast-follow を見直す必要はない。
